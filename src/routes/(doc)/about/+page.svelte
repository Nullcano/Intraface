...
<div class="my-4 pa-3 br-3 bg-light-2 stack gap-2">
  <hgroup>
    <h3>What's Coming Next</h3>
    <i class="fs-1">Upcoming features lined up to enhance your Intraface experience.</i>
  </hgroup>
  <div class="pa-2 br-2 bg-light-1">
    <div class="mb-1 grid auto-fill ai-center gap-1">
      <div class="w-1 h-1 br-circle bg-light-5"></div>
      <strong>Shorthand Classes</strong>
    </div>
    <p>Say goodbye to writing lengthy combinations of CSS properties. Intraface is introducing shorthand classes that make styling a breeze. For instance, use <code class="bg-light-3">&lt;div class="stack"&gt;</code>, and it's equivalent to <code class="bg-light-3">&lt;div class="flex flex-col"&gt;</code>.</p>
  </div>
  <div class="pa-2 br-2 bg-light-1">
    <div class="mb-1 grid auto-fill ai-center gap-1">
      <div class="w-1 h-1 br-circle bg-light-5"></div>
    ...
    <p>Building complex components is about to get a whole lot easier. Intraface will offer specialized classes designed for crafting components without the need for an extensive array of classes in your markup. Just <code class="bg-light-3">&lt;div class="card"&gt;</code>, and you've got yourself a pre-styled box.</p>
  </div>
  <div class="pa-2 br-2 bg-light-1">
    <div class="mb-1 grid auto-fill ai-center gap-1">
      <div class="w-1 h-1 br-circle bg-light-5"></div>
    ...
    <p>No need to load the entire system when you only require specific functionality. Intraface is rolling out module bundles, providing subsets of CSS tailored for specific uses. For instance, load <code class="bg-light-3">if.colors.min.css</code> to access only the coloring utilities you need.</p>
  </div>
</div>
<div class="grid col-2 gap-2">
  <div></div>
