...
<nav class="fixed ml-2 pa-2 br-3 b-all bw-1 b-light-4 top-50 left-0 y-center flex flex-col ai-center gap-1">
  <a role="menuitem" href="/plugins" class="{currentPath.includes('plugins') ? `${cssString} bg-violet-3` : cssString}" tabindex="0">
  ...
  <a role="menuitem" href="/theming" class="{currentPath.includes('theming') ? `${cssString} bg-violet-3` : cssString}" tabindex="0">
    ...
    <span class="absolute top-50 y-center left-100 ml-3 pa-3 br-2 white bg-violet-3 none">Theming</span>
  </a>
  <a role="menuitem" href="/semantics" class="{currentPath.includes('semantics') ? `${cssString} bg-violet-3` : cssString}" tabindex="0">
    <svg class="w-2 h-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <span class="absolute top-50 y-center left-100 ml-3 pa-3 br-2 white bg-violet-3 none">Semantics</span>
  </a>
  <a role="menuitem" href="/skins" class="{currentPath.includes('skins') ? `${cssString} bg-violet-3` : cssString}" tabindex="0">
    <svg class="w-2 h-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <span class="absolute top-50 y-center left-100 ml-3 pa-3 br-2 white bg-violet-3 none">Skins</span>
  </a>
</nav>
