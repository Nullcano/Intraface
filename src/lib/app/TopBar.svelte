...
<header class="sticky top-0 w-fill px-2 flex ai-center gap-2 bg-light-1 br-2 z-1">
  <a class="pa-2 if ai-center gap-2 u-0" href="/">
  ...
  <div class="pa-2 bg-light-2 br-pill none block_s">
    Menu
  </div>
  <div class="spacer"></div>
  <a class="block pa-2 u-0" href="/sitemap">Sitemap</a>
  <button class="w-2 h-2 grid place-center bg-light-2" on:click={toggleTheme}>
    {@html darkMode ? 
